...
const Home = () => (
  <div className="main-content home">
    ...
    library is continually refreshed with the latest on web technology so you will never fall behind.
    </p>
  </div>
)
  ...
  return (
    <div className="main-content">
      ...
      <ul className="course-nav">
        <li className="courseBtn">  <NavLink exact to="/courses/html"> HTML </NavLink> </li>
        <li className="courseBtn">  <NavLink to="/courses/css"> CSS </NavLink> </li>
        <li className="courseBtn">  <NavLink to="/courses/javascript"> JavaScript </NavLink> </li>
      </ul>
